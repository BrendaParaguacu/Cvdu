...
<head>
  ...
  <!--TITULO DA PÁGINA-->
  <title>Alterar Cadastro Funcionário</title>
  <!--Icone da aba-->
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Alterar Cadastro Funcionario</span></a></li>
            ...
            <div class="main-content pl-3" id="main-content">
              ...
              <div class="row" style="padding: 25px; margin: auto;">
                <div class="col-12 br-card">
                  <form name="adiciona" method="post" action="..\..\..\..\Controller\ControladorAlterarFuncionario.php">
                    <div class="br-card" id="card0" style="width: 600px">
                      <div class="card-content">
                        <h3 class="text-sm-center">Alterar Cadastro Funcionário</h3>
                      </div>
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input id="codFuncionario" type="hidden" name="codFuncionario" value="<?php echo $_SESSION["codFuncionario"]; ?>">
                            <input id="nome" type="text" placeholder="Digite o nome do funcionário" class="" style="width: 578px" name="nome" value="<?php echo $_SESSION["nomeFuncionario"]; ?>">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input id="rg" oninput="mascaraRG(this)" type="text" placeholder="Digite o RG" class="" style="width: 578px" name="rg" value="<?php echo $_SESSION["rg"]; ?>">
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO DOSE-->
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input id="cpf" oninput="mascaraCPF(this)" type="text" placeholder="Digite somente números" class="" style="width: 578px" name="cpf" value="<?php echo $_SESSION["cpf"]; ?>">
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO DOSE-->
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input id="especialidade" type="text" placeholder="Informe a especialidade" class="" style="width: 578px" name="especialidade" value="<?php echo $_SESSION["especialidade"]; ?>">
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO DOSE-->
