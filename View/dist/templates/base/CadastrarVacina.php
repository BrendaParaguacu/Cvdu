    ...
    <main id="main">
      <div class="container-lg">
        <div class="row" id="container-grid">
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item" href=""><span class="content">Cadastrar Vacina</span></a></li>
          ...
          <!--INICIO AREA DE CADASTRAR VACINA-->
                ...
                <div class="col-12 br-card">
                  <div class="br-card" id="card0" style="width: 600px">
                    <div class="card-content">
                      <h3 class="text-sm-center">Cadastrar Vacina</h3>
                    </div>
                    <!--INICIO-->
                    <form name="adiciona" method="post" action="..\..\..\..\Controller\ControladorCadastroVacina.php">
                      <!-- CAMPO DE TEXTO NOME VACINA JÁ FORMATADO -->
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            <label for="cpf-id1">Nome da Vacina</label>
                            <input id="cpf-id1" type="text" placeholder="Digite o nome da vacina" name="nome" class="form-control" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO NOME VACINA-->
                      <!--CAMPO DE TEXTO FABRICANTE JÁ FORMATADO-->
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            <label for="cpf-id1">Fabricante</label>
                            <input id="cpf-id1" type="text" placeholder="Digite o nome do fabricante" class="form-control" name="fabricante" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO FABRICANTE-->
                      <!-- CAMPO DE TEXTO TIPO JÁ FORMATADO -->
                      <div class="row justify-content-center" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col">
                          <div class="br-select">
                            <div class="br-input">
                              <label for="select-simple">Tipo</label>
                              <input id="select-simple" type="text" placeholder="Informe o tipo da vacina" name="tipo" class="" style="width: 578px">
                            </div>
                            <div class="br-list" tabindex="0">
                              <div class="br-item" tabindex="-1">
                                <div class="br-radio">
                                  <input id="rb0" type="radio" name="radio">
                                  <label for="rb0">Viral</label>
                                </div>
                              </div>
                              <div class="br-item" tabindex="-1">
                                <div class="br-radio">
                                  <input id="rb1" type="radio" name="radio">
                                  <label for="rb1">Bacteriana</label>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <!--FIM CAMPO DE TEXTO TIPO-->
                      <!-- CAMPO DE TEXTO DOSE JÁ FORMATADO -->
                      <div class="row justify-content-center" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col">
                          <div class="br-select">
                            <div class="br-input">
                              <label for="select-simple">Número De Doses</label>
                              <input id="select-simple" type="text" placeholder="Informe a quantidade de doses" name="ndoses" class="" style="width: 578px">
                            </div>
                            <div class="br-list" tabindex="0">
                              <div class="br-item" tabindex="-1">
                                <div class="br-radio">
                                  <input id="rb2" type="radio" name="radio">
                                  <label for="rb2">Dose Unica</label>
                                </div>
                              </div>
                              <div class="br-item" tabindex="-1">
                                <div class="br-radio">
                                  <input id="rb3" type="radio" name="radio">
                                  <label for="rb3">2 Doses</label>
                                </div>
                              </div>
                              <div class="br-item" tabindex="-1">
                                <div class="br-radio">
                                  <input id="rb4" type="radio" name="radio">
                                  <label for="rb4">3 Doses</label>
                                </div>
                              </div>
                              <div class="br-item" tabindex="-1">
                                <div class="br-radio">
                                  <input id="rb5" type="radio" name="radio">
                                  <label for="rb5">Dose Anual</label>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            <label for="cpf-id1">Eficácia</label>
                            <input id="cpf-id1" type="text" placeholder="Informe a eficácia" name="eficacia" class="form-control" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO DOSE-->
                      ...
                      <button class="br-button primary mt-3 mt-sm-0 ml-sm-3" onclick="" style="margin-bottom: 15px;" type="submit" value="incluir">Cadastrar</button></input>
