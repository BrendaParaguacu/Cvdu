<?php
   session_start();
   require "..\Model\ClasseAlterarRegistro.php";

   $acao =  $_POST["acao"];
   $codRegistro = $_POST["codRegistro"];
 
   $registro = new AlterarRegistro($codRegistro);
   $registroDAO = new AlterarRegistroDAO();
   ...
   if ($acao=="consultar"){
      ...
      if ( $registro->pesquisar() ){
         ...
         echo $_SESSION["dose"];
         header('Location: ..\View\dist\templates\base\AlterarRegistro.php');
      }   
      ...
      header('Location: ..\View\dist\templates\base\InserirDose.php');
   }
?>