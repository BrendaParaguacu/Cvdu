    ...
    <main id="main">
      <div class="container-lg">
        <div class="row" id="container-grid">
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Alterar Registro de Aplicação de Dose</span></a></li>
                          <li><a class="menu-item active" href="ResultadoConsultaPaciente.php"><span class="content">Voltar a Consulta do Paciente</span></a></li>
          ...
          <!--INICIO FORMULÁRIO DA TELA-->
          <div class="row" style="padding: 25px; margin: auto;">
            <form name="adiciona" method="post" action="..\..\..\..\Controller\ControladorAlterarRegistro.php">
              <div class="br-card" id="card0" style="width: 600px">
                <div class="card-content">
                  <h3 class="text-sm-center">Alterar Registro de Aplicação de Dose</h3>
                </div>
                <!-- CAMPO DE TEXTO DOSE JÁ FORMATADO -->
                <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                  <div class="col-sm-10">
                    <div class="br-input">
                      <label for="cpf-id1">Nome Vacina</label>
                      <input id="cpf-id1" type="text" placeholder="Digite o nome" name="nomeVacina" value="<?php echo $_SESSION["nomeVacina"]; ?>" class="" style="width: 578px">
                    </div>
                  </div>
                </div>
                ...
                <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                  <div class="col-sm-10">
                    <div class="br-input">
                      <label for="cpf-id1">Lote</label>
                      <input id="cpf-id1" oninput="mascaraRG(this)" type="text" placeholder="Digite o RG" name="lote" value="<?php echo $_SESSION["lote"]; ?>" class="" style="width: 578px">
                    </div>
                  </div>
                </div>
                <!--FIM CAMPO DE TEXTO DOSE-->
                ...
                <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                  <div class="col-sm-10">
                    <div class="br-input">
                      <label for="cpf-id1">Nome do Aplicador</label>
                      <input id="cpf-id1" type="text" placeholder="Digite o nome do aplicador" name="nomeAplicador" value="<?php echo $_SESSION["nomeAplicador"]; ?>" class="" style="width: 578px">
                    </div>
                  </div>
                </div>
                <!--FIM CAMPO DE TEXTO DOSE-->
                ...
                <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                  <div class="col-sm-10">
                    <div class="br-input">
                      <label for="cpf-id1">Data da Aplicação</label>
                      <input id="cpf-id1" oninput="mascaraDATA(this)" type="text" placeholder="Digite somente números" name="dataAplicacao" value="<?php echo $_SESSION["dataAplicacao"]; ?>" class="" style="width: 578px">
                    </div>
                  </div>
                </div>
                <!--FIM CAMPO DE TEXTO DOSE-->
                <!-- CAMPO DE TEXTO DOSE JÁ FORMATADO -->
                <div class="row justify-content-center" style="padding-left: 10px; padding-bottom: 10px;">
                  <div class="col">
                    <div class="br-select">
                      <div class="br-input">
                        <label for="select-simple">Dose</label>
                        <input id="select-simple" type="text" placeholder="Informe a dose aplicada" name="dose" value="<?php echo $_SESSION["dose"]; ?>" class="" style="width: 578px">
                      </div>
                      <div class="br-list" tabindex="0">
                        <div class="br-item" tabindex="-1">
                          <div class="br-radio">
                            <input id="rb0" type="radio" name="radio">
                            <label for="rb0">Dose Unica</label>
                          </div>
                        </div>
                        <div class="br-item" tabindex="-1">
                          <div class="br-radio">
                            <input id="rb1" type="radio" name="radio">
                            <label for="rb1">1 Dose</label>
                          </div>
                        </div>
                        <div class="br-item" tabindex="-1">
                          <div class="br-radio">
                            <input id="rb2" type="radio" name="radio">
                            <label for="rb2">2 Dose</label>
                          </div>
                        </div>
                        <div class="br-item" tabindex="-1">
                          <div class="br-radio">
                            <input id="rb3" type="radio" name="radio">
                            <label for="rb3">3 Dose</label>
                          </div>
                        </div>
                        <div class="br-item" tabindex="-1">
                          <div class="br-radio">
                            <input id="rb4" type="radio" name="radio">
                            <label for="rb4">Dose Anual</label>
                          </div>
                        </div>
                        <div class="br-item" tabindex="-1">
                          <div class="br-radio">
                            <input id="rb5" type="radio" name="radio">
                            <label for="rb5">Reforco</label>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <!--FIM CAMPO DE TEXTO DOSE-->
                <!--BOTÃO DE INSERIR-->
                <input type="hidden" name="acao" value="AlterarRegistro">
                <input type="hidden" name="codRegistro" value="<?php echo $_SESSION["codRegistro"]; ?>">
        ...
        <div class="d-none d-sm-block">
          <div class="row align-items-end justify-content-between py-5">
            ...
            <div class="col assigns text-right">
              <a href="http://www.acessoainformacao.gov.br/"><img class="ml-4" src="../../../../imagens/ZlptTHB4NzBvRWNVUm55TkNERWpXUTo6bGFpLnBuZw.png" alt="Imagem"> Acesso á informação</a>
