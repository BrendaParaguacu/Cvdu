                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Cadastrar Funcionário</span></a></li>
                ...
                <div class="col-12 br-card">
                  <div class="br-card" id="card0" style="width: 600px">
                    <div class="card-content">
                      <h3 class="text-sm-center">Cadastro Funcionário</h3>
                    </div>
                    <!--INICIO-->
                    <form name="adiciona" method="post" action="..\..\..\..\Controller\ControladorCadastroFuncionario.php">
                      <!-- CAMPO DE TEXTO NOME FUNCIONARIO JÁ FORMATADO -->
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            <div class="form-group">
                              <label for="cpf-id1">Nome </label>
                              <input id="cpf-id1" type="text" placeholder="Digite o nome do funcionário" name="nome" class="form-control" style="width: 578px">
                            </div>
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO NOME FUNCIONARIO-->
                      <!--CAMPO DE TEXTO RG JÁ FORMATADO-->
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            <label for="cpf-id1">RG</label>
                            <input id="cpf-id1" oninput="mascaraRG(this)" type="text" placeholder="Digite o RG" class="form-control" name="rg" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            <label for="cpf-id1">CPF</label>
                            <input id="cpf-id1" oninput="mascaraCPF(this)" type="text" placeholder="Digite somente números" name="cpf" class="form-control" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      <!--FIM CAMPO DE TEXTO DOSE-->
                      <!-- CAMPO DE TEXTO ESPECIALIDADE JÁ FORMATADO -->
                      <div class="row justify-content-center mb-5" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col">
                          <div class="br-select">
                            <div class="br-input">
                              <label for="select-simple">Especialidade</label>
                              <input id="select-simple" type="text" placeholder="Informe a especialidade" name="especialidade" class="" style="width: 578px">
                            </div>
                            <div class="br-list" tabindex="0">
                              <div class="br-item" tabindex="-1">
                                <div class="br-radio">
                                  <input id="rb0" type="radio" name="radio">
                                  <label for="rb0">Gerente</label>
                                </div>
                              </div>
                              <div class="br-item" tabindex="-1">
                                <div class="br-radio">
                                  <input id="rb2" type="radio" name="radio">
                                  <label for="rb2">Aplicador</label>
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <!--FIM CAMPO DE TEXTO ESPECIALIDADE-->
                      <!--INICIO BOTÃO DE INSERIR-->
