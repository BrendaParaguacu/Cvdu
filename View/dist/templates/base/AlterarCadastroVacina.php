...
<head>
  ...
  <!--TITULO DA PÁGINA-->
  <title>Alterar Cadastro Vacina</title>
  <!--Icone da aba-->
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Alterar Cadastro Vacina</span></a></li>
            ...
            <div class="main-content pl-3" id="main-content">
              ...
              <div class="row" style="padding: 25px; margin: auto;">
                <div class="col-12 br-card">
                  <form name="adiciona" method="post" action="..\..\..\..\Controller\ControladorAlterarVacinas.php">
                    <div class="card-content">
                      <h3 class="text-sm-center">Alterar Cadastro Vacina</h3>
                    </div>
                    ...
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          ...
                          <input id="codigo" type="hidden" name="codVacina" style="width: 578px" value="<?php echo $_SESSION["codVacina"]; ?>">
                          <input id="nome" type="text" placeholder="Digite o nome da vacina" name="nomeVacina" style="width: 578px" value="<?php echo $_SESSION["nomeVacina"]; ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          ...
                          <input id="fabricante" type="text" placeholder="Digite o nome do fabricante" name="fabricante" style="width: 578px" value="<?php echo $_SESSION["fabricante"]; ?>">
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO DOSE-->
                    ...
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          ...
                          <input id="tipo" type="text" placeholder="Digite o tipo da vacina" name="tipo" style="width: 578px" value="<?php echo $_SESSION["tipo"]; ?>">
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO DOSE-->
                    ...
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          <label for="ndoses">Número De Doses</label>
                          <input id="ndoses" type="text" placeholder="Digite a quantidade de doses" name="ndoses" style="width: 578px" value="<?php echo $_SESSION["ndoses"]; ?>">
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO DOSE-->
                    ...
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          ...
                          <input id="eficacia" type="text" placeholder="Informe a eficácia" name="eficacia" style="width: 578px" value="<?php echo $_SESSION["eficacia"]; ?>">
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO DOSE-->
