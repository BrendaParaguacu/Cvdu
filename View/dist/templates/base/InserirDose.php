        ...
        <div class="row" id="container-grid">
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item " href="#"><span class="content">Inserir Dose Paciente Consultado</span></a></li>
          ...
          <div class="col" id="container-content">
            <div class="main-content pl-3" id="main-content">
              <!--FIM MENU LATERAL CENTRO DA TELA-->
              <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorInserirDose.php">
                <div class="row" style="padding: 20px; margin: auto;">
                  <div class="br-card" id="card0" style="width: 600px">
                    <!--INICIO INSERIR DOSE-->
                    <div class="card-content">
                      <h3 class="text-sm-center">Inserir Dose</h3>
                    </div>
                    ...
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          ...
                          <input id="nomeVacina" name="nomeVacina" type="text" placeholder="Digite o nome da vacina" class="" style="width: 578px">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          ...
                          <input id="lote" name="lote" oninput="mascaraLOTE(this)" type="text" placeholder="Digite apenas numeros" class="" style="width: 578px">
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO DOSE-->
                      ...
                      <div class="col">
                        <div class="br-select">
                          <div class="br-input">
                            ...
                            <input id="select-simple" type="text" placeholder="Informe a dose aplicada" name="dose" class="" style="width: 578px">
                          </div>
                    ...
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-10">
                        <div class="br-input">
                          <label for="nomeAplicador">Nome do Aplicador</label>
                          <input id="nomeAplicador" name="nomeAplicador" type="text" placeholder="Informe o nome do aplicador" class="" style="width: 578px">
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO NOME APLICADOR-->
                    <!--CAMPO DE TEXTO DATA APLICAÇÃO JÁ FORMATADO-->
                    <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                      <div class="col-sm-12 col-lg-4">
                        <div class="br-datetimepicker" data-mode="single" data-type="text">
                          <div class="br-input has-icon">
                            <label for="simples-input">Data da Aplicação</label>
                            <input class="has-icon flatpickr-input" id="simples-input" name="dataAplicacao" style="width: 578px" type="text" placeholder="dd/mm/aaaa" data-input="data-input" readonly="readonly">
                            <button class="br-button circle small" type="button" aria-label="Abrir Timepicker" data-toggle="data-toggle" id="simples-input-btn"></button>
                          </div>
                        </div>
                      </div>
                    </div>
                    <!--FIM CAMPO DE TEXTO DATA APLICAÇÃO-->
                    <!--BOTÃO DE INSERIR-->
                    <input type="hidden" name="acao" value="incluir">
                    <input type="hidden" name="rgPaciente" value="<?php echo $_SESSION["rgPaciente"]; ?>">
                    <input class="br-button primary mt-3 mt-sm-0 ml-sm-3" style="margin-bottom: 10px;" onclick="Cadastro()" type="submit" value="Inserir">
