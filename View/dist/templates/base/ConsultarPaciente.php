                    ...
                    <div class="col-sm-4 col-lg-3">
                      <div class="menu-panel">
                        <div class="menu-header">
                          ...
                          <div class="menu-title"><img src="../../../../imagens/1280px-Gov.br_logo.svg.png"
                        ...
                        <nav class="menu-body">
                          <div class="menu-folder">
                            ...
                            <ul>
                              <li><a class="menu-item"><span class="content">Atenção Primária</span></a>
                                <ul>
                                  <li><a class="menu-item"
                                      href="https://www.gov.br/saude/pt-br/assuntos/atencao-primaria/saude-da-familia"><span
                                        class="content">Saúde Da Familia</span></a></li>
                                  <li><a class="menu-item"
                                      href="https://www.gov.br/saude/pt-br/assuntos/atencao-primaria/ciclos-da-vida"><span
                                        class="content">Ciclos Da Vida</span></a></li>
                                </ul>
                              </li>
                              <li><a class="menu-item"><span class="content">Assistência Farmacêutica</span></a>
                                <ul>
                                  <li><a class="menu-item"
                                      href="https://www.gov.br/saude/pt-br/assuntos/assistencia-farmaceutica-no-sus/base-nacional-de-dados-de-acoes-e-servicos-da-assistencia-farmaceutica-do-sistema-unico-de-saude-bnafar"><span
                                        class="content">Base Nacional de Dados de Ações e Serviços da Assistência
                              ...
                              <li><a class="menu-item"><span class="content">Boletins Epidemiológicos</span></a>
                                <ul>
                                  <li><a class="menu-item"
                                      href="https://www.gov.br/saude/pt-br/assuntos/boletins-epidemiologicos/numeros-anteriores"><span
                                        class="content">Números Anteriores</span></a></li>
                                  <li><a class="menu-item"
                                      href="https://www.gov.br/saude/pt-br/assuntos/boletins-epidemiologicos/numeros-recentes"><span
                                        class="content">Números Recentes</span></a></li>
                                  <li><a class="menu-item"
                                      href="https://www.gov.br/saude/pt-br/assuntos/boletins-epidemiologicos/por-assunto"><span
                                        class="content">Por Assunto</span></a></li>
                                </ul>
                              </li>
                              <li><a class="menu-item" href="https://localizasus.saude.gov.br/"><span
                                    class="content">Localiza SUS</span></a></li>
                              <li><a class="menu-item" href="https://saudeindigena.saude.gov.br/corona"><span
                                    class="content">Saúde Indigena</span></a></li>
                            </ul>
                          </div>
                          <div class="menu-folder"><a class="menu-item"><span class="content">Coronavírus</span></a>
                            <ul>
                              <li><a class="menu-item"><span class="content">Vacinas</span></a>
                                <ul>
                                  <li><a class="menu-item"
                                      href="https://www.gov.br/saude/pt-br/coronavirus/vacinas/grupos-de-trabalho-gt"><span
                                        class="content">Grupo de Trabalho (GT)</span></a></li>
                                </ul>
                              </li>
                              <li><a class="menu-item"
                                  href="https://www.gov.br/saude/pt-br/coronavirus/entregas-de-vacinas-covid-19"><span
                                    class="content">Entrega de Vacinas Covid-19</span></a></li>
                              <li><a class="menu-item"
                                  href="https://www.gov.br/saude/pt-br/coronavirus/boletins-epidemiologicos"><span
                                    class="content">Boletins Epidemiológicos</span></a></li>
                            </ul>
                          </div>
                          <div class="menu-folder"><a class="menu-item">
                            ...
                            <ul>
                              <li><a class="menu-item"
                                  href="https://www.gov.br/saude/pt-br/canais-de-atendimento/ouvidoria-do-sus"><span
                                    class="content">Ouvidoria SUS</span></a></li>
                            </ul>
                          </div>
                          <div class="menu-folder">
                            <a class="menu-item">
                            ...
                            <ul>
                              <li><a class="menu-item"
                                  href="https://www.gov.br/saude/pt-br/campanhas-da-saude/2019"><span
                                    class="content">2019</span></a></li>
                              <li><a class="menu-item"
                                  href="https://www.gov.br/saude/pt-br/campanhas-da-saude/2020"><span
                                    class="content">2020</span></a></li>
                              <li><a class="menu-item"
                                  href="https://www.gov.br/saude/pt-br/campanhas-da-saude/2021"><span
                                    class="content">2021</span></a></li>
                            </ul>
                          </div>
                        </nav>
                        <div class="menu-footer">
                          ...
                          <div class="menu-social">
                            ...
                            <div class="sharegroup">
                              <div class="share">
                                <a class="br-button circle" href="https://www.twitter.com/minsaude"
                                  aria-label="Compartilhar por Twitter">
                                  <i class="fab fa-twitter" aria-hidden="true"></i>
                                </a>
                                <a class="br-button circle" href="https://www.youtube.com/minsaudebr"
                                  aria-label="Compartilhar por Youtube">
                                  <i class="fab fa-youtube" aria-hidden="true"></i>
                                </a>
                                <a class="br-button circle" href="https://www.facebook.com/minsaude"
                                  aria-label="Compartilhar por Facebook">
                                  <i class="fab fa-facebook-f" aria-hidden="true"></i>
                                </a>
                                <a class="br-button circle" href="https://www.instagram.com/minsaude"
                                  aria-label="Compartilhar por Instagram">
                                  <i class="fab fa-instagram" aria-hidden="true"></i>
                                </a>
                                <a class="br-button circle" href="https://soundcloud.com/ministeriodasaude"
                                  aria-label="Compartilhar por SoundCloud">
                                  <i class="fab fa-soundcloud" aria-hidden="true"></i>
                                </a>
                                <a class="br-button circle" href="https://www.flickr.com/ministeriodasaude"
                                  aria-label="Compartilhar por Flickr">
    ...
    <main id="main">
      <div class="container-lg">
        <div class="row" id="container-grid">
                ...
                <div class="menu-container">
                  <div class="menu-panel">
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          <li><a class="menu-item" href="#"><span class="content">Consultar Paciente</span></a></li>
          ...
          <!--INICIO CONSULTA PACIENTE-->
          <div class="col" id="container-content">
            <div class="main-content pl-3" id="main-content">
              <!--INICIO INSERIR DOSE-->
              <div class="row" style="padding: 25px; margin: auto;">
                <div class="col-12 br-card">
                  <div class="br-card" id="card0" style="width: 600px">
                    <div class="card-content">
                      <h3 class="text-sm-center">Consultar Paciente</h3>
                    </div>
                    <!--INICIO-->
                    <form method="post" action="..\..\..\..\Controller\ControladorConsultaPaciente.php">
                      <!-- CAMPO DE TEXTO DOSE JÁ FORMATADO -->
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            <label for="rg">RG</label>
                            <input id="rg" type="text" oninput="mascaraRG(this)" placeholder="Digite somente números"
                              name="rg" class="form-control" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input id="dataNascimento" type="text" oninput="mascaraDATA(this)"
                              placeholder="Digite somente números" class="form-control" name="dataNascimento"
                              style="width: 578px">
                          </div>
                        </div>
                      </div>
                      ...
                      <p class="text-center text-danger">
                        <?php
                          if (isset($_SESSION['PacienteInexistente'])) {
                            echo $_SESSION['PacienteInexistente'];
                            unset($_SESSION['PacienteInexistente']);
                          }
                        ?>
                      </p>
                      <!--BOTÃO DE ENTRAR-->
                      <input type="hidden" name="acao" value="consulta1">

                      <input class="br-button primary mt-3 mt-sm-0 ml-sm-3" style="margin-bottom: 10px;" type="submit"
                        value="consultar">
                    </form>
                  </div>
                </div>
        ...
        <div class="d-none d-sm-block">
          <div class="row align-items-end justify-content-between py-5">
            ...
            <div class="col assigns text-right">
              <a href="http://www.acessoainformacao.gov.br/"><img class="ml-4"
                  src="../../../../imagens/ZlptTHB4NzBvRWNVUm55TkNERWpXUTo6bGFpLnBuZw.png" alt="Imagem"> Acesso á
                informação</a>
              <a href="http://www.brasil.gov.br/"><img class="ml-4" src="../../../../imagens/logo-gov.png"
                  alt="Imagem"></a>
            </div>
          </div>
        </div>
