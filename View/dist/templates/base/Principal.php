<?php
session_start();
require("..\..\..\..\Model\ClasseVacinasDAO.php");
...
<head>
  ...
  <!--TITULO DA PÁGINA-->
  <title>Principal Gerente - CVDU </title>
  <!--Icone da aba-->
        ...
        <div class="row" id="container-grid">
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item" href="#"><span class="content">Principal Gerente</span></a></li>
                        </ul>
                      </div>
                    </nav>
                  </div>
          ...
          <div class="col" id="container-content">
            <div class="main-content pl-3" id="main-content">
              <!--INICIO AREA DA TABELA DE VACINAS CADASTRADAS-->
              <div class="br-card" id="card0">
                <!--Titulo-->
                <div class="card-content">
                  <h3 class="text-sm-center">Vacinas Cadastradas</h3>
                </div>
                <!-- INICIO DA TABELA COM AS VACINAS JÁ CADASTRADAS-->
                <div class="container-fluid">
                  <div class="br-table" data-search="data-search" data-selection="data-selection">
                    <div class="responsive" style="padding: 20px">
                      <table>
                        <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorAlterarVacinas.php">
                          <div class="row">
                            <div class="col-sm-5">
                              <div class=" p-1">
                                <div class="br-input" data-filter="data-filter">
                                  <input type="text" placeholder="Digite o código da vacina" name="codVacina">
                                </div>
                              </div>
                            </div>
                            <input type="hidden" name="acao" value="consultar">
                            <input class="br-button secondary active" type="submit" value="Alterar Cadastro">
                          </div>
                        </form>
                        <thead>
                          ...
                          <tr>
                            ...
                            <th scope="col">N° De Doses</th>
                            <th scope="col">Eficácia</th>
                          </tr>
                        </thead>
                        <!--INICIO VIZUALIZAÇÃO DAS VACINAS-->
                        <?php $vacinasDAO->visualizar(); ?>
                        <!--FIM VIZUALIZAÇÃO DAS VACINAS-->
                      </table>
                    </div>
                  </div>
                </div>
                <!--FIM DA TABELA DE VACINAS-->
              </div>
              <!--FIM AREA DA TABELA DE VACINAS CADASTRADAS-->
              <!--INICIO AREA DA TABELA DE FUNCIONARIOS CADASTRADOS-->
              <div class="br-card" id="card0">
                <!--Titulo-->
                <div class="card-content">
                  <h3 class="text-sm-center">Funcionários Cadastrados</h3>
                </div>
                <!-- INICIO DA TABELA COM AS FUNCIONÁRIOS JÁ CADASTRADOS-->
                <div class="container-fluid">
                  <div class="br-table" id="minhaDiv" data-search="data-search" data-selection="data-selection">
                    <div class="responsive" style="padding: 20px">
                      <table>
                        <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorAlterarFuncionario.php">
                          <div class="row">
                            <div class="col-sm-5">
                              <div class=" p-1">
                                <div class="br-input" data-filter="data-filter">
                                  <input type="text" placeholder="Digite o código do funcionário" name="codFuncionario">
                                </div>
                              </div>
                            </div>
                            <input type="hidden" name="acao" value="consultar">
                        ...
                        <!-- INICIO VISUALIZAÇÃO DE FUNCIONARIOS-->
                        <?php $vacinasDAO->visualizarFuncionario(); ?>
                        <!--FIM VISUALIZAÇÃO DE FUNCIONARIOS-->
                      </table>
                    </div>
                  </div>
                </div>
                <!--FIM DA TABELA DE FUNCIONARIOS JÁ CADASTRADOS-->
              </div>
              <!--FIM AREA DA TABELA DE FUNCIONARIOS CADASTRADOS-->
            </div>
          </div>
        </div>
      </div>
