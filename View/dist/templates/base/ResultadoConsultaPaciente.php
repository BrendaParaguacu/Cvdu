<?php
session_start();
require("..\..\..\..\Model\ClasseResultadoConsultaPacienteDAO.php");
$ResultadoConsultaPacienteDAO = new ResultadoConsultaPacienteDAO();
?>
<!DOCTYPE html>
<html lang="pt-BR">
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item" href="#"><span class="content">Consulta de Paciente</span></a></li>
          ...
          <div class="col" id="container-content">
            <div class="main-content pl-3" id="main-content">
              <div class="br-card" id="card0">
                <!--INICIO DA AREA DAS VACINAS RECEBIDAS-->
                <div class="card-content">
                  <h3 class="text-sm-center">Cartão do Paciente</h3>
                </div>
                <div class="container-fluid">
                  <div class="br-table" data-search="data-search" data-selection="data-selection">
                    <div class="responsive" style="padding: 20px">
                      <table>
                        <div class="row">
                          <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorAlterarRegistro.php">
                            <div class="col-sm-5">
                              <div class=" p-1">
                                <div class="br-input" data-filter="data-filter">
                                  <input type="text" placeholder="Digite o código do registro" name="codRegistro" required>
                                </div>
                              </div>
                            </div>
                            <input type="hidden" name="acao" value="consultar">
                            <input class="br-button secondary active" type="submit" value="Alterar Registro">
                          </form>
                          <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorAlterarRegistro.php">
                            <input type="hidden" name="acao" value="inserirDose">
                            <input type="hidden" name="rg" value="<?php echo $_SESSION['rg']; ?>">
                            <input class="br-button secondary active" type="submit" value="Inserir Dose">
                          </form>
                        </div>
                        ...
                        <!-- INICIO VIZUALIZAÇÃO DOS DADOS DO PACIENTE-->
                        <form name="consulta" method="post" action="..\..\..\..\Controller\ControladorAlterarPaciente.php">
                          <tr>
                            <td data-th=”Título coluna 1”>
                              <input type="hidden" name="acao" value="consulta1">
                              <input type="hidden" name="rg" value="<?php echo $_SESSION['rg']; ?>">
                              <button class="br-button secondary active"><i class="fas fa-edit" style="font-size:24px">
                            </td>
                            <td data-th=”Título coluna 1”>
                              <?php echo $_SESSION['nome']; ?>
                            </td>
                            <td data-th=”Título coluna 1”>
                              <?php echo $_SESSION['rg']; ?>
                            </td>
                            <td data-th=”Título coluna 2”>
                              <?php echo $_SESSION['dataNascimento']; ?>
                            </td>
                            <td data-th=”Título coluna 1”>
                              <?php echo $_SESSION['nSus']; ?>
                            </td>
                          </tr>
                        </form>
                        <!-- FIM VIZUALIZAÇÃO DOS DADOS DO PACIENTE-->
                        <thead>
                          <!--PARTE SUPERIOR DA TABELA-->
                          <tr>
                            ...
                            <th scope="col">Nome Do Aplicador</th>
                            <th scope="col">Data da Aplicação</th>
                            <th scope="col">Dose</th>
                          </tr>
                        </thead>
                        <!--INICIO CARDS DAS VACINAS RECEBIDAS-->
                        <?php $ResultadoConsultaPacienteDAO->visualizarVacinasPaciente(); ?>
                        <!--FIM CARDS DAS VACINAS RECEBIDAS-->

                      </table>
                    </div>
                  </div>
                </div>
                <!--FIM DA AREA DAS VACINAS RECEBIDAS-->
              </div>
            </div>
          </div>
        </div>
