        ...
        <div class="row" id="container-grid">
                    ...
                    <nav class="menu-body">
                      <div class="folder">
                        <ul>
                          ...
                          <li><a class="menu-item" href=""><span class="content">Cadastrar Paciente</span></a></li>
          ...
          <div class="col" id="container-content">
            <div class="main-content pl-3" id="main-content">
              <!--INICIO DO CADASTRO-->
              <form method="post" action="..\..\..\..\Controller\ControladorCadastroPaciente.php" style="padding: 37px;">
                <div class="row">
                  <div class="col-12 br-card">
                    <div class="br-card" id="card0" style="width: 600px">
                      <div class="card-content">
                        <h3 class="text-sm-center">Cadastrar Paciente</h3>
                      </div>
                      <!-- CADASTRO NOME -->
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input name="nome" id="nome" type="text" placeholder="Digite o nome" class="" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      <!--FIM NOME-->
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input name="rg" id="rg" oninput="mascaraRG(this)" type="text" placeholder="Digite o RG" class="" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      <!--FIM RG-->
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            ...
                            <input name="dataNascimento" id="dataNascimento" oninput="mascaraDATA(this)" type="text" placeholder="Digite somente números" class="" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      <!--FIM DATA NASCIMENTO-->
                      ...
                      <div class="row" style="padding-left: 10px; padding-bottom: 10px;">
                        <div class="col-sm-10">
                          <div class="br-input">
                            <label for="nSus">Número SUS</label>
                            <input name="nSus" id="nSus" oninput="mascaraSUS(this)" type="text" placeholder="Digite o numero do cartão do SUS" class="" style="width: 578px">
                          </div>
                        </div>
                      </div>
                      <!--FIM N SUS-->
                      ...
                      <input class="br-button primary mt-3 mt-sm-0 ml-sm-3" style="margin-bottom: 10px;" onclick="Cadastro()" type="submit" value="Cadastrar">
                      <!--FIM BOTÃO DE CADASTRAR-->
                    </div>
                  </div>
                </div>
              </form>
